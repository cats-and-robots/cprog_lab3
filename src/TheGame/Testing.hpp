...
void test_Room(){
	using UP_C = std::unique_ptr<Character>;
	...
	UP_C actor_1(new EvilCat("MadCat") );
	UP_C actor_2(new Cat("Siamese") );
	UP_C actor_3(new CafeRobot("Bob") );
	UP_I inv_1(new Inventory);
	UP_O temp_wep1(new Weapon("Axe", "Heavy Axe", 10,3));
	inv_1->put(std::move(temp_wep1));
	UP_C actor_4(new EvilRobot("PetaMan", 10));
...
//	currentRoom->directions();
	...
	UP_C get_robot_1 = currentRoom->leave("Bob");
...
void test_Player(){
	...
	std::unique_ptr<Character> er1(new EvilRobot("Evil Asimo"));
	std::unique_ptr<Character> ec1(new EvilCat("Evil Munchkin"));
	std::unique_ptr<Character> c1(new Cat("Munchkin"));
	std::unique_ptr<Character> cr1(new CafeRobot("R2D2"));
...
//////////////////////////////////////////////////////////////////
void test_CharacterVector(){
	using FP = std::unique_ptr<Character>;
